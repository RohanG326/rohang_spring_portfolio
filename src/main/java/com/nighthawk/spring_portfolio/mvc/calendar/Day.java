...
public class Day {
   ...
   private void setDayOfYear() {  // this is private to avoid tampering
    ...
    public String toJSON(){
        return String.format("{ \"year\": %d, \"month\": %d, \"day\": %d, \"dayOfWeek\": \"%s\", \"dayOfYear\": \"%s\"}", this.year, this.month, this.day, this.days[dayOfWeek], this.dayOfYear, this.birthday);
    }	
